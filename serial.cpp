...
int* KNN(ArffData* train, ArffData* test, int k) {    
    ...
    //         printf("%.2f ", train_matrix[i*train->num_attributes() + j]);
    //     }
    //     printf("\n");
    // }
    ...
    //         printf("%.2f ", test_matrix[i*test->num_attributes() + j]);
    //     }
    //     printf("\n");
    // }
    ...
    for(int queryIndex = 0; queryIndex < test_num_instances; queryIndex++) {
        ...
        for(int i = 0; i < k; i++) {
            ...
            // printf("%d ", classCounts[(int)candidates[2*i+1]]);
        }
        // printf("\n");
